        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="lightbee.png" alt="Card image cap"
                            id="product-detail">
                    </div>
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">Surron Light Bee X</h1>
                            <p class="h3 py-2">$5800.00</p>
                            <p class="py-2">
                            ...
                            <h6>Description:</h6>
                            <p>Designed for off-road, rough terrain, cross-country trails.
                                The multi-link suspension of the SURRON X bike copes with any irregularities.
                                Off-road tires give maximum grip with dirt, sand, stones.
                                The controller is set to the maximum engine speed of 5400 rpm.
                                The weight of the bike is minimum 50 kg.</p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        <ul class="list-inline pb-3">
                                            ...
                                            <li class="list-inline-item"><span class="btn btn-warning"
